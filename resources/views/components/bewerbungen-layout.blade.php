...
@php
    $defaultNavItems = [
        ...
        ['label' => 'App-Info', 'href' => route('apps.bewerbungen.info'), 'icon' => 'information-circle', 'description' => 'Installierte Version und Release-Historie', 'buttonText' => 'App-Info anzeigen'],
